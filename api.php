...
<body>
    ...
    <div id="__next">
        <nav opacity="0" class="Nav__Navbar-sc-1cqvak9-0 bOVFzz">
            <img src="logo.jpg" width="30" height="30" style="border-radius: 30px">
            <a href="index.php" class="NavLogo__StyledLink-sc-y37qlc-0 feEeet">
        ...
        <main><br><br>
            <div class="blog__Container-sc-1r9k7f4-0 fqkZaR">
                <div class="blog__HeaderContainer-sc-1r9k7f4-1 gpJXD">
                    <h1 class="blog__SectionTitle-sc-1r9k7f4-2 IFQoh">API</h1>
                ...
                <section class="AllPosts__Section-sc-6aropc-0 kcFeoT">
                    ...
                    <div class="AllPosts__Container-sc-6aropc-1 hsgcUN">
                        ...
                        <?php
                        $req = $bdd->prepare('SELECT * FROM api ORDER BY id DESC');
                        $req->execute([]);
                        $etudes = $req->fetchAll();
                        foreach ($etudes as $a) {
                        ?>
