...
<body>
    ...
    <div id="__next">
        <nav opacity="0" class="Nav__Navbar-sc-1cqvak9-0 bOVFzz"><img src="logo.jpg" width="30" height="30" style="border-radius: 30px"><a href="index.php" class="NavLogo__StyledLink-sc-y37qlc-0 feEeet">
...
SHAI'DY
        ...
        <main><br><br>
            <div class="blog__Container-sc-1r9k7f4-0 fqkZaR">
                <div class="blog__HeaderContainer-sc-1r9k7f4-1 gpJXD">
                    ...
                    <div class="BlogCategorySelector__SelectorContainer-sc-ghsvil-0 rJEyo"><select id="select-blog-category" class="BlogCategorySelector__Select-sc-ghsvil-1 gUrpat no-zoom">
                            <?php
                    ...
                    <div class="AllPosts__Container-sc-6aropc-1 hsgcUN">
                        ...
                        ?>
                                    <a href="<?php echo $a['lien'] ?>" class="PostCardPreview__Container-sc-1j4wnl5-0 eQyRpe">
                                        <div class="PostCardPreview__ImgContainer-sc-1j4wnl5-1 eDeQuS"><span style="box-sizing:border-box;display:block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:absolute;top:0;left:0;bottom:0;right:0"><img src="upload/<?php echo $a['image'] ?>" decoding="async" data-nimg="fill" class="image" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%;object-fit:cover;background-size:cover;background-position:0% 0%" /><noscript><img sizes="100vw" decoding="async" data-nimg="fill" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%;object-fit:cover" class="image" loading="lazy" /></noscript></span></div>
    ...
    <script>
        var selectElement = document.getElementById('select-blog-category');
